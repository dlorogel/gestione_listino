		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestione Listino",
									"targetURL": "#itorogelgestionelistino-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogelgestionelistino-display": {
								"semanticObject": "itorogelgestionelistino",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.gestionelistino",
									"url": sap.ui.require.toUrl("it/orogel/gestionelistino")
								}
							}
						}
					}
